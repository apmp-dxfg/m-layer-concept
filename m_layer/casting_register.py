...
class CastingRegister(object):
    ...
    """
    A `CastingRegister` holds a mapping scale pairs 
    to information about how to convert between scales. 
    Casting involves a change in the type of scale, which 
    differs from 'conversion' where the scale type remains the same.
    """
